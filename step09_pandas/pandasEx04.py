...
city2 = pd.Series({'서울':10022181, '대전':1518775, '대구':247829, '부산':3531777})
print(city2)

# 순서를 변경하고하면 index를 리스트로 지정하면 된다
print('-----딕셔너리 객체에서 시리스 생성(순서 변경) --------')
city3 = pd.Series({'서울':10022181, '대전':1518775, '대구':247829, '부산':3531777, '인천':2925815 }, index=['서울','부산','대구','대전'])
print(city3)
